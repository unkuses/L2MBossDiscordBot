...
public static class BossCollection
{
    public static List<BossDbModel> GetBossesCollection()
        ...
        [
            ...
            new BossDbModel(id: 2, name: "Chertuba", chance: 50, location: "Gludio", nickName: "чертуба",
                respawnTime: 3)
            {
                BossNames = new List<BossNamesDBModel>() { new(name: "Чертуба"), new(name: "Chertuba") }
            },

            new BossDbModel(id: 3, name: "Kelsus", chance: 50, location: "Gludio", nickName: "кельсус", respawnTime: 6,
            ...
            new BossDbModel(id: 26, location: "Dion", name: "Gahareth", chance: 50, respawnTime: 6,
                restartRespawnTime: 6,
                nickName: "гарет")
            {
            ...
            new BossDbModel(id: 18, location: "Giran", respawnTime: 6, restartRespawnTime: 6, name: "Behemoth",
                chance: 100,
                nickName: "чудовище")
            {
            ...
            new BossDbModel(id: 51, location: "Goddard", name: "Baron", nickName: "Бароша", restartRespawnTime: 14,
                respawnTime: 24, chance: 33, purpleDrop: true)
            {
                BossNames = new List<BossNamesDBModel>() { new("Барон"), new("Baron") }
            },

            new BossDbModel(id: 52, location: "Goddard", name: "Hecaton", nickName: "Бекон", restartRespawnTime: 14,
                respawnTime: 24, chance: 33, purpleDrop: true)
            {
            ...
            // Veora
            new BossDbModel(id: 53, location: "Veora", name: "Moof", nickName: "Муфа", chance: 100, respawnTime: 12,
                restartRespawnTime: 14, purpleDrop: true)
            {
                BossNames = new List<BossNamesDBModel>() { new("Муфа"), new("Moof") }
            },

            new BossDbModel(id: 54, location: "Veora", name: "Normus", nickName: "Нормус", chance: 100, respawnTime: 18,
                restartRespawnTime: 14, purpleDrop: true)
            {
                BossNames = new List<BossNamesDBModel>() { new("Normus"), new("Нормус") }
            },

            new BossDbModel(id: 55, location: "Veora", name: "Shila", nickName: "Силла", chance: 100, respawnTime: 12,
                restartRespawnTime: 14, purpleDrop: true)
            {
                BossNames = new List<BossNamesDBModel>() { new("Силла"), new("Shila") }
            },

            new BossDbModel(id: 56, location: "Veora", name: "Ukanba", nickName: "Уканба", chance: 100, respawnTime: 18,
                restartRespawnTime: 14, purpleDrop: true)
            {
                BossNames = new List<BossNamesDBModel>() { new("Уканба"), new("Ukanba") }
            }
        ];
}
